...
CONFIG_PATH="${CONFIG_PATH:-${REPO_DIR}/configs/cpgrpo_denovo_mean_baseline_std_ng512_bs2048_lr5e-5_beta5e-3_ni1_ms2000_4gpu.yaml}"
...
CACHE_TAG="sgrpo_mean_baseline_std_4gpu_${UID}_$$"
...
echo "Launching 4-GPU mean-baseline plus std training from commit $(git rev-parse --short HEAD)"
